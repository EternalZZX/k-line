$(function () {
  ...
  $.getScript('http://data.gtimg.cn/flashdata/hushen/latest/weekly/sz000006.js', function (data) {
    ...
    arr.forEach(function (item) {
      ...
      var date = '20' + arrItem[0].substring(0, 2) + '-' + arrItem[0].substring(2, 4) + '-' + arrItem[0].substring(4, 6);
      rawData.push([date, arrItem[1], arrItem[2], arrItem[4], arrItem[3], arrItem[5]]);
    });
    drawChart(rawData);
  }).fail(function (err) {
    console.log(err);
